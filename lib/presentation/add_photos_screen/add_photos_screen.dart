                            ...
                            child: GestureDetector(
                                onTap: () async {
                                  ...
                                  controller.getImageList
                                      .add(AddphotosItemModel(file, false));
                                  controller.update();
                                },
                                child: _buildCaption(
                ...
                controller.getImageList.isNotEmpty
                    ? GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          AddphotosItemModel data =
                              controller.getImageList[index];
                          return Container(
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.only(
                                  topLeft:
                                      Radius.circular(index == 3 ? 0 : 16.h),
                                  topRight:
                                      Radius.circular(index == 2 ? 0 : 16.h),
                                  bottomLeft:
                                      Radius.circular(index == 1 ? 0 : 16.h),
                                  bottomRight:
                                      Radius.circular(index == 0 ? 0 : 16.h),
                                ),
